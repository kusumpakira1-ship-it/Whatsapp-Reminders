...
from services.waha_service import send_waha_message, send_waha_file, get_session_status, get_session_qr
from core.config import settings
from apscheduler.triggers.date import DateTrigger
from db.database import SessionLocal
from db.models import ReportRecipient, Group, Employee, ProcessedData, SystemSetting, CustomAlarm
...
def setup_scheduler():
    ...
    scheduler.start()
    logger.info("APScheduler started. Daily, Weekly, Monthly reports and Targeted Reminders are scheduled.")
