...
db.commit()
print(f"Synced {inserted_count} new messages into sunfra_raw_messages for {today_str}.")
...
print("COMPLETE PER-EMPLOYEE LOGOUT & ATTENDANCE AUDIT:\n")
for grp in data['groups']:
    ...
    for emp in grp['employees']:
        ...
        detail = emp['detail']
        print(f"• {ename:<12} | Login: {ltime:<10} | Logout: {otime:<10} | Badge: {badge:<30} | Detail: {detail}")
