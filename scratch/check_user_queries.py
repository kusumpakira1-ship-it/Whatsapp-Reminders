...
queries = {
    'Roopa': ['roopa', 'rupa', '147635256201243', '8686856459'],
    'Bhanushree': ['bhanu', 'bhanushree', '81991244460218', '9901497574'],
    'Parvati': ['parvati', 'paru', '245225503076572', '7995452523'],
    'Jagadish': ['jagadish', '7676711899'],
    'Asif': ['asif', 'unfazed', '42932509909155', '6364063475'],
    'Nani': ['nani', '112300593815672', '26049698091190', '7204041105'],
    'Balaji': ['balaji', '242695733772318', '9493928388']
}
...
db.close()
print("Done writing query_results.txt")
