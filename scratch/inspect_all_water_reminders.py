"""
Inspect all water monitoring system rows in DB
"""
import sys
...
db = SessionLocal()
try:
    print("=== ALL UNIFIED REMINDERS MATCHING WATER ===")
    ...
    for r in rems:
        ...
        print(f"Reports: '{r.report_types}' | Notes: '{r.task_notes}' | Status: '{r.status}'")
        print("-" * 60)

    print("\n=== ALL TASKS MATCHING WATER ===")
