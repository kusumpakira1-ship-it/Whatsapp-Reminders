...
class Flock(Base):
    ...
    running_days = Column(Integer, nullable=True, default=0)
    running_weeks = Column(Integer, nullable=True, default=0)
    initial_chicks = Column(Integer, nullable=False, default=0)
    live_birds = Column(Integer, nullable=True, default=None)
